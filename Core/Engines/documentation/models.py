...
from Core.Engines.modules.documentation import (
    get_icon,
    rich_attack_links,
    GitlabMarkdown,
    sanitize_hover,
...
from Core.Engines.modules.documentation_components import (
    criticality_doc,
    classification_doc,
    metadata_doc,
    reference_doc,
...
from Core.Engines.modules.files import safe_file_name
from Core.Engines.modules.graphs import relationships_graph, chaining_graph
...
from Core.Engines.templates.models import MODEL_DOC_TEMPLATE

ROOT = Path(str(git.Repo(".", search_parent_directories=True).working_dir))
MODELS_DOCS_PATH = ROOT / DataTide.Configurations.Documentation.models_docs_folder
