...
from Core.Engines.modules.framework import techniques_resolver, relations_list, get_type
...
from Core.Engines.templates.wiki_navigation import NAV_INDEX_TEMPLATE
